import{H as e,R as t,b as n,d as r,ft as i,nt as a,p as o,u as s,v as c,xt as l,y as u}from"./chunks/runtime-core.esm-bundler.D1rrvi5M.js";import"./chunks/es.CKDDWwOB.js";import{t as d}from"./chunks/table.80EJRnbF.js";var f=n({__name:`basic`,setup(e){let n=i([{id:1,name:`需求评审`,amount:1200,status:`pending`},{id:2,name:`接口开发`,amount:3400,status:`active`},{id:3,name:`联调测试`,amount:800,status:`done`}]),a=[{type:`selection`,width:55},{type:`index`,label:`#`,width:55},{prop:`id`,label:`ID`,width:80},{prop:`name`,label:`名称`,editable:!0,editor:`input`,required:!0},{prop:`amount`,label:`金额`,align:`right`,width:140,editable:!0,editor:{type:`input-number`,props:{min:0,step:100,controls:!1}},formatter:e=>`¥ ${(e.amount??0).toLocaleString(`zh-CN`)}`},{prop:`status`,label:`状态`,width:140,editable:!0,editor:{type:`select`,props:{options:[{label:`待开始`,value:`pending`},{label:`进行中`,value:`active`},{label:`已完成`,value:`done`}]}},formatter:e=>({pending:`待开始`,active:`进行中`,done:`已完成`})[e.status]??``}];return(e,i)=>(t(),r(l(d),{data:n.value,"onUpdate:data":i[0]||=e=>n.value=e,columns:a,"row-key":`id`,border:``},null,8,[`data`]))}}),p=`<script setup lang="ts">
