...
`;const tn=JSON.parse(`{"title":"AntTable","description":"基于 Ant Design Vue a-table 的增强表格","frontmatter":{"title":"AntTable","description":"基于 Ant Design Vue a-table 的增强表格"},"headers":[],"relativePath":"components/ant-table/index.md","filePath":"components/ant-table/index.md"}`);var nn=M({name:`components/ant-table/index.md`,setup(e){return(e,t)=>{let n=u(`ClientOnly`),r=u(`DemoBlock`);return F(),C(`div`,null,[t[0]||=j(`<h1 id="anttable" tabindex="-1">AntTable <a class="header-anchor" href="#anttable" aria-label="Permalink to “AntTable”">​</a></h1><p>基于 Ant Design Vue <code>a-table</code> 的增强表格，沿用 antd 原生列式 API（<code>columns</code> 数组、<code>dataIndex</code>/<code>title</code>、<code>customRender</code>）：可编辑单元格、仿 Excel 键盘导航与热键、行/单元格校验、单元格联动（dependencies）、行增删改与撤销重做、列设置持久化、脏数据追踪、服务端分页与自适应高度。</p><p>与 <a href="/component-labs/components/plus-table.html">PlusTable</a> 能力对齐，区别仅在底层 UI 库与 API 风格：PlusTable 用 Element Plus + <code>el-table-column</code> 配置，AntTable 用 Ant Design Vue + <code>columns</code> 数组。</p>`,3),_(r,{title:`基础用法`,description:`配置式列 + cell 编辑模式，双击单元格即可编辑。`,source:c(Yt)},{default:O(()=>[_(n,null,{default:O(()=>[_(Jt)]),_:1})]),_:1},8,[`source`]),t[1]||=j(`<h2 id="快速开始" tabindex="-1">快速开始 <a class="header-anchor" href="#快速开始" aria-label="Permalink to “快速开始”">​</a></h2><div class="language-vue line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">script</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> setup</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> lang</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;ts&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span>
