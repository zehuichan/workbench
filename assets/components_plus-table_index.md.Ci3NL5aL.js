...
`;const Be=JSON.parse(`{"title":"PlusTable","description":"基于 Element Plus el-table 的增强表格","frontmatter":{"title":"PlusTable","description":"基于 Element Plus el-table 的增强表格"},"headers":[],"relativePath":"components/plus-table/index.md","filePath":"components/plus-table/index.md"}`);var Ve=O({name:`components/plus-table/index.md`,setup(e){return(e,t)=>{let n=c(`ClientOnly`),r=c(`DemoBlock`);return A(),x(`div`,null,[t[0]||=h(`h1`,{id:`plustable`,tabindex:`-1`},[k(`PlusTable `),h(`a`,{class:`header-anchor`,href:`#plustable`,"aria-label":`Permalink to “PlusTable”`},`​`)],-1),t[1]||=h(`p`,null,[k(`基于 Element Plus `),h(`code`,null,`el-table`),k(` 的增强表格：配置式列、三种编辑模式（单元格 / 整行 / 全表）、仿 Excel 热键、列设置持久化、行校验与联动（dependencies）、行操作、服务端分页与自适应高度。`)],-1),m(r,{title:`基础用法`,description:`配置式列 + cell 编辑模式：双击 / Enter / F2 进入编辑，直接打字覆盖输入。`,source:o(Ne)},{default:w(()=>[m(n,null,{default:w(()=>[m(Me)]),_:1})]),_:1},8,[`source`]),t[2]||=D(`<h2 id="快速开始" tabindex="-1">快速开始 <a class="header-anchor" href="#快速开始" aria-label="Permalink to “快速开始”">​</a></h2><div class="language-vue line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">script</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> setup</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> lang</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;ts&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">} </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;@labs/plus-table&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div>`,34)])}}});export{Be as __pageData,Ve as default};