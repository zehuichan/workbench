import{Gt as e,H as t,Jt as n,R as r,b as i,ft as a,l as o,nt as s,p as c,u as l,ut as u,v as d,w as f,xt as p,y as m}from"./chunks/runtime-core.esm-bundler.D1rrvi5M.js";import{f as h,m as g}from"./chunks/es.CKDDWwOB.js";import{t as _}from"./chunks/plugin-vue_export-helper.dQSkT9tV.js";import{t as v}from"./chunks/plus-table.CQ7lEmFH.js";var y={class:`demo-toolbar`},b={class:`demo-toolbar`},x={class:`demo-statusbar`},S={class:`demo-statusbar__item`},C={class:`demo-statusbar__item`},w={class:`demo-statusbar__item demo-statusbar__item--grow`},T={class:`demo-table-title`},E=_(i({__name:`playground`,setup(i){let _=[`技术部`,`产品部`,`设计部`,`市场部`],E={技术部:[`张三`,`李四`],产品部:[`王五`,`赵六`],设计部:[`陈七`,`周八`],市场部:[`周八`,`陈七`]},D=[`前端组`,`后端组`,`UI组`,`运营组`],O=[{label:`待开始`,value:`pending`},{label:`进行中`,value:`active`},{label:`已完成`,value:`done`}],k=[{label:`高`,value:`high`},{label:`中`,value:`medium`},{label:`低`,value:`low`}],A={pending:{label:`待开始`,type:`info`},active:{label:`进行中`,type:`warning`},done:{label:`已完成`,type:`success`}},j=1;function M(e){let t=[`pending`,`active`,`done`],n=[`low`,`medium`,`high`],r=_[e%_.length],i=E[r];return{id:j++,name:`任务 ${e+1} — ${[`需求评审`,`接口开发`,`联调测试`,`UI 走查`,`性能优化`][e%5]}`,status:t[e%3],priority:n[e%3],amount:1e3+e%20*500,department:r,assignee:i[e%i.length],team:D[e%D.length],remark:`备注 ${e+1}`}}let N=a(Array.from({length:30},(e,t)=>M(t))),P=a(1),F=a(10),I=o(()=>N.value.length),L=o({get:()=>{let e=(P.value-1)*F.value;return N.value.slice(e,e+F.value)},set:e=>{let t=(P.value-1)*F.value,n=Math.min(F.value,Math.max(N.value.length-t,0)),r=[...N.value];r.splice(t,n,...e),N.value=r}}),R=a(),z=a(`cell`),B=a(`change`),V=a(`—`),H=a(`—`),U=u(new Set),W=a(!0),G=a(!0),K=a(`none`),q=o(()=>K.value===`none`?!1:K.value===`container`?{mode:`container`}:!0),J=o(()=>W.value?{limit:50}:!1),Y=o(()=>R.value?.getModifiedRows().length??0),X=[{key:`Ctrl+S`,override:!0,handler:()=>{Q()}},{key:`Ctrl+D`,override:!0,when:e=>e.rowIndex>=0,handler:e=>{R.value?.duplicateRow(e.rowIndex,{id:j++})}}];function Z(e){V.value=`行 ${e.rowIndex+1} / ${e.prop}：${JSON.stringify(e.oldValue)} → ${JSON.stringify(e.value)}`}async function Q(){let e=await R.value?.validate();H.value=e?.valid?`OK`:`${e?.errors.length} 个错误`}function $(){R.value?.clearValidate(),H.value=`—`}function ee(){R.value?.insertRow(M(N.value.length))}async function te(e,t){await R.value?.commitRowEdit(t)&&U.delete(e.id)}function ne(e,t){R.value?.startRowEdit(t),U.add(e.id)}function re(e,t){R.value?.cancelRowEdit(t),U.delete(e.id)}let ie=[{type:`index`,label:`#`,width:50,fixed:`left`},{prop:`id`,label:`ID`,width:70,fixed:`left`},{prop:`name`,label:`任务名称`,minWidth:200,editable:!0,editor:`input`,required:!0,rules:[{min:2,max:50,message:`长度 2–50`}]},{prop:`status`,label:`状态`,width:110,editable:!0,editor:{type:`select`,props:{options:O}},render:({value:e})=>{let t=A[String(e)]??{label:`未知`,type:`info`};return f(h,{type:t.type,size:`small`,disableTransitions:!0},()=>t.label)}},{prop:`priority`,label:`优先级`,width:110,editable:!0,editor:{type:`select`,props:{options:k}},formatter:e=>({high:`高`,medium:`中`,low:`低`})[e.priority]??``,dependencies:{triggerFields:[`status`],disabled:e=>e.status===`done`}},{prop:`amount`,label:`金额`,align:`right`,width:130,editable:!0,editor:{type:`input-number`,props:{min:0,step:100,controls:!1}},formatter:e=>`¥ ${(e.amount??0).toLocaleString(`zh-CN`)}`,rules:[{type:`number`,min:0,message:`金额不能为负`}]},{label:`组织信息`,children:[{prop:`department`,label:`部门`,width:120,editable:!0,editor:{type:`select`,props:{options:_.map(e=>({label:e,value:e}))}}},{prop:`assignee`,label:`负责人`,width:130,editable:!0,editor:`select`,dependencies:{triggerFields:[`department`],required:e=>e.status===`active`,componentProps:e=>({options:(E[e.department]??[]).map(e=>({label:e,value:e}))}),trigger:(e,t)=>{(E[e.department]??[]).includes(e.assignee)||t.setValue(`assignee`,void 0)}}},{prop:`team`,label:`团队`,width:110}]},{prop:`remark`,label:`备注`,minWidth:140,editable:!0},{type:`operation`,label:`操作`,width:190,fixed:`right`,align:`center`,render:({row:e,rowIndex:t})=>{let n=[];return z.value===`row`&&(U.has(e.id)?n.push(f(g,{link:!0,type:`primary`,size:`small`,onClick:()=>te(e,t)},()=>`保存`),f(g,{link:!0,size:`small`,onClick:()=>re(e,t)},()=>`取消`)):n.push(f(g,{link:!0,type:`primary`,size:`small`,onClick:()=>ne(e,t)},()=>`编辑`))),n.push(f(g,{link:!0,size:`small`,onClick:()=>R.value?.duplicateRow(t,{id:j++})},()=>`复制`),f(g,{link:!0,type:`danger`,size:`small`,onClick:()=>R.value?.removeRow(t)},()=>`删除`)),f(`span`,n)}}];return(i,a)=>{let o=t(`el-radio-button`),u=t(`el-radio-group`),f=t(`el-divider`),h=t(`el-checkbox`),_=t(`el-input`);return r(),c(`div`,null,[l(`div`,y,[a[21]||=l(`span`,{class:`label`},`编辑模式`,-1),m(u,{modelValue:z.value,"onUpdate:modelValue":a[0]||=e=>z.value=e,size:`small`},{default:s(()=>[m(o,{value:`none`},{default:s(()=>[...a[11]||=[d(`none`,-1)]]),_:1}),m(o,{value:`cell`},{default:s(()=>[...a[12]||=[d(`cell`,-1)]]),_:1}),m(o,{value:`row`},{default:s(()=>[...a[13]||=[d(`row`,-1)]]),_:1}),m(o,{value:`table`},{default:s(()=>[...a[14]||=[d(`table`,-1)]]),_:1})]),_:1},8,[`modelValue`]),m(f,{direction:`vertical`}),a[22]||=l(`span`,{class:`label`},`校验时机`,-1),m(u,{modelValue:B.value,"onUpdate:modelValue":a[1]||=e=>B.value=e,size:`small`},{default:s(()=>[m(o,{value:`change`},{default:s(()=>[...a[15]||=[d(`change`,-1)]]),_:1}),m(o,{value:`blur`},{default:s(()=>[...a[16]||=[d(`blur`,-1)]]),_:1}),m(o,{value:`manual`},{default:s(()=>[...a[17]||=[d(`manual`,-1)]]),_:1})]),_:1},8,[`modelValue`]),m(f,{direction:`vertical`}),m(p(g),{size:`small`,type:`primary`,onClick:Q},{default:s(()=>[...a[18]||=[d(`校验`,-1)]]),_:1}),m(p(g),{size:`small`,onClick:$},{default:s(()=>[...a[19]||=[d(`清除校验`,-1)]]),_:1}),m(p(g),{size:`small`,onClick:ee},{default:s(()=>[...a[20]||=[d(`插入行`,-1)]]),_:1})]),l(`div`,b,[m(p(g),{size:`small`,disabled:!R.value?.canUndo,onClick:a[2]||=e=>R.value?.undo()},{default:s(()=>[...a[23]||=[d(` 撤销 Ctrl+Z `,-1)]]),_:1},8,[`disabled`]),m(p(g),{size:`small`,disabled:!R.value?.canRedo,onClick:a[3]||=e=>R.value?.redo()},{default:s(()=>[...a[24]||=[d(` 重做 Ctrl+Shift+Z `,-1)]]),_:1},8,[`disabled`]),m(h,{modelValue:W.value,"onUpdate:modelValue":a[4]||=e=>W.value=e,size:`small`},{default:s(()=>[...a[25]||=[d(`启用撤销重做`,-1)]]),_:1},8,[`modelValue`]),m(f,{direction:`vertical`}),m(h,{modelValue:G.value,"onUpdate:modelValue":a[5]||=e=>G.value=e,size:`small`},{default:s(()=>[...a[26]||=[d(`启用脏数据追踪`,-1)]]),_:1},8,[`modelValue`]),m(p(g),{size:`small`,disabled:!G.value,onClick:a[6]||=e=>R.value?.resetTracking()},{default:s(()=>[...a[27]||=[d(` 重置脏标记 `,-1)]]),_:1},8,[`disabled`]),m(f,{direction:`vertical`}),a[31]||=l(`span`,{class:`label`},`自适应高度`,-1),m(u,{modelValue:K.value,"onUpdate:modelValue":a[7]||=e=>K.value=e,size:`small`},{default:s(()=>[m(o,{value:`none`},{default:s(()=>[...a[28]||=[d(`关闭`,-1)]]),_:1}),m(o,{value:`viewport`},{default:s(()=>[...a[29]||=[d(`viewport`,-1)]]),_:1}),m(o,{value:`container`},{default:s(()=>[...a[30]||=[d(`container`,-1)]]),_:1})]),_:1},8,[`modelValue`])]),l(`div`,x,[l(`span`,S,[a[32]||=l(`span`,{class:`demo-statusbar__k`},`校验`,-1),d(n(H.value),1)]),a[35]||=l(`span`,{class:`demo-statusbar__sep`},`|`,-1),l(`span`,C,[a[33]||=l(`span`,{class:`demo-statusbar__k`},`脏行数`,-1),d(n(Y.value),1)]),a[36]||=l(`span`,{class:`demo-statusbar__sep`},`|`,-1),l(`span`,w,[a[34]||=l(`span`,{class:`demo-statusbar__k`},`cell-change`,-1),d(n(V.value),1)])]),l(`div`,{class:e({"demo-container-box":K.value===`container`})},[m(p(v),{ref_key:`tableRef`,ref:R,data:L.value,"onUpdate:data":a[8]||=e=>L.value=e,page:P.value,"onUpdate:page":a[9]||=e=>P.value=e,"page-size":F.value,"onUpdate:pageSize":a[10]||=e=>F.value=e,columns:ie,total:I.value,"edit-mode":z.value,"validate-on":B.value,adaptive:q.value,history:J.value,"dirty-tracking":G.value,hotkeys:X,"row-key":`id`,"column-setting":{storageKey:`docs-playground`},border:``,onCellChange:Z},{toolbar:s(()=>[l(`span`,T,`任务管理（`+n(I.value)+` 条）`,1)]),"header-name":s(()=>[...a[37]||=[l(`span`,{style:{color:`var(--el-color-primary)`}},`任务名称`,-1)]]),"editor-remark":s(({value:e,setValue:t})=>[m(_,{"model-value":e,placeholder:`自定义编辑器插槽…`,size:`small`,"onUpdate:modelValue":t},null,8,[`model-value`,`onUpdate:modelValue`])]),_:1},8,[`data`,`page`,`page-size`,`total`,`edit-mode`,`validate-on`,`adaptive`,`history`,`dirty-tracking`])],2),a[38]||=l(`p`,{class:`demo-hint`},[d(` 提示：在列设置里隐藏「任务名称」（必填列）后点击「校验」，仍会报出该列的必填错误——校验不因列被隐藏而失效。 `),l(`code`,null,`Ctrl+S`),d(` 触发校验、`),l(`code`,null,`Ctrl+D`),d(` 复制当前行为自定义热键（`),l(`code`,null,`hotkeys`),d(` prop）示例。 `)],-1)])}}}),[[`__scopeId`,`data-v-0e4bc9f8`]]),D=`<script setup lang="ts">
